import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,o as a,d as i}from"./app--nBeKGPX.js";const e={},p=i(`<h3 id="代码格式审核" tabindex="-1"><a class="header-anchor" href="#代码格式审核"><span>代码格式审核</span></a></h3><blockquote><p>使用phpcs.phar</p></blockquote><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>@echo OFF</span></span>
